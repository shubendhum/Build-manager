...
const RESPONSES = {
  ...
  "/timeline": {
    ...
    steps: [{ n: 1, key: "pre-start", name: "Pre-start preparation", detail: "d",
              mandatory: false, days: 10, parallel: false, start: "2026-09-01",
              finish: "2026-09-14", state: "current", behind: false, packages: [],
              booked_start: null }],
