...
KEYWORDS = [
    ...
    ("plumbing-rough-in",     ("rough-in", "rough in", "roughin")),
    ...
    ("slab-prep",             ("slab", "waffle", "footing", "pier", "pile", "screw pile")),
    ("site-cut",              ("site cut", "excavat", "earthwork", "site prep", "bulk earth")),
    ("waterproof-tiling",     ("waterproof", "tiling", "tiler", "tile")),
    ("insulation",            ("insulation", "batts")),
    ("plaster",               ("plaster", "gyprock", "plasterboard", "cornice")),
    ("painting",              ("paint",)),
    ("internal-fixing",       ("internal fix", "skirting", "architrave", "cabinet", "kitchen", "joinery", "wardrobe", "stair")),
    ("final-finishes",        ("floor covering", "shower screen", "mirror", "garage door", "appliance")),
    ("external-works",        ("driveway", "landscap", "fencing", "path", "stormwater")),
    ("pre-start",             ("fencing", "toilet", "survey", "set-out", "set out", "asset protection")),
]
