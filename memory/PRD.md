...
## Prioritized Backlog
- P0 (Phase 4): Per-project Photos tab UI; document storage; "Export to Site Diary" PDF (approved).
- P2 (Phase 5): polish, forgot-password flow.
- Perf note: dashboard.py calls compute_budget per project (N+1); optimize if portfolio >20 projects.
